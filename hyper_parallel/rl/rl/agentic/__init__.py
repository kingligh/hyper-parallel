...
_EXPORTS = {
    ...
    "INTERACTION_PROTOCOLS": ("rl.agentic.tools", "INTERACTION_PROTOCOLS"),
    "InteractionMode": ("rl.agentic.core.types", "InteractionMode"),
    "InteractionProtocol": ("rl.agentic.tools", "InteractionProtocol"),
    "JsonFunctionCallProtocol": ("rl.agentic.tools", "JsonFunctionCallProtocol"),
    "Observation": ("rl.agentic.core.types", "Observation"),
    "OpenAIToolCallProtocol": ("rl.agentic.tools", "OpenAIToolCallProtocol"),
    "ParsedAction": ("rl.agentic.tools", "ParsedAction"),
    "ProgramAgentRunner": ("rl.agentic.core.program_runner", "ProgramAgentRunner"),
    "ResponseParser": ("rl.agentic.tools", "ResponseParser"),
    ...
    "ToolExecutorProtocol": ("rl.agentic.tools", "ToolExecutorProtocol"),
...
# PEP 562 requires these exact names to keep optional harness imports lazy.
