...
def _validate_adapter_config(vllm_config: VllmConfig) -> None:
    """Reject unsupported model or parallel settings for the Qwen3 adapter."""
...
class HyperQwen3ForCausalLM(Qwen3ForCausalLM):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = "") -> None:
        ...
        if tp_size > 1:
            ...
            self._tp_placements = {
                ...
                for name, (placements, unused_source_mesh) in tp_layout_info.items()
            }
    ...
    def load_weights(
        ...
        *,
        ...
        """Load complete Qwen3 parameters, optionally across multiple calls."""
        parameters = dict(self.named_parameters())  # pylint: disable=not-callable
